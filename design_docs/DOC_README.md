...
|---|---|
| [Arena semantic contract](../docs/2026-06-11_gc_arena_dom_plan.md#g5-arena-semantic-contract-agreed-planned-2026-09-07) | G5 partially implemented: S1 replacement retention and S2 root closure are committed with bounded automated regressions; S3 remains research. Full native headed retain/detach/collect/adopt/mutate/render/release acceptance through scripted Ortet remains open; no browser-hosted acceptance is recorded. |
