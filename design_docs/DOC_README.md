...
| [K6 fragmentation](../docs/2026-08-15_buckram_k6_fragmentation_execution_plan.md) | K6a typed inputs landed in `c685b0c7147`. All 6,077 named records match the frozen pre-K6 baseline. Geometry and continuations remain unimplemented; K6b is next. |
